      ...
      <section className="relative min-h-[40vh] lg:min-h-[55vh] flex items-center justify-center py-10 lg:py-16 px-4 overflow-hidden">
        ...
        <div className="container relative z-10 mx-auto max-w-4xl text-center">
          <div className="flex flex-col items-center">
            ...
            <h1 className="mt-6 text-2xl lg:text-5xl font-black text-white tracking-widest uppercase leading-relaxed drop-shadow-md animate-fade-in-up opacity-0 [animation-delay:400ms]">
