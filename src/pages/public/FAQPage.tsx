    ...
    <div className="container mx-auto py-12 px-4 max-w-4xl">
      <div className="text-center mb-12">
        ...
        <div className="relative max-w-xl mx-auto">
          ...
          <Input 
            className="w-full pl-12 h-14 rounded-full text-base bg-white border-neutral-200 shadow-sm focus-visible:ring-green-600" 
        ...
        {loading ? (
          ...
          <Accordion className="w-full space-y-4">
            {filteredFaqs.map((faq) => (
              <AccordionItem key={faq.id} value={`item-${faq.id}`} className="border border-neutral-200 px-6 rounded-2xl bg-neutral-50/50 data-[state=open]:bg-white data-[state=open]:border-green-200 data-[state=open]:shadow-sm transition-all">
      ...
      <div className="mt-12 bg-green-900 rounded-3xl p-8 text-center text-white">
        ...
        <Button size="lg" className="bg-white text-green-900 hover:bg-neutral-100 h-12">
